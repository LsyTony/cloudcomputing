...
class RegisterDialog extends Component {
    ...
    render() {
        ...
        if (this.state.errorCode === 'errorLogin') {
            ...
            errMsg = <Alert bsStyle="warning">
                <strong>Incorrect username / passwords not matching! / insufficient passwords length!</strong>
            </Alert>;
        }
            ...
            errMsg = <Alert bsStyle="warning">
                <strong>Please agree to the terms&conditions by ticking the box</strong>
            </Alert>;
        }
        return (
