                    ...
                    <Modal.Body>
                        ...
                        <Form horizontal>
                            <FormGroup controlId="formHorizontalCode">
                                ...
                                <Col sm={10}>
                                    <FormControl type="text" placeholder="where" onChange={(event) => this.setState({ event_address: event.target.value })} />
                                </Col>
                                <Col componentClass={ControlLabel} sm={2}>
                                    Time:
                                </Col>
                                <Col sm={10}>
                                    <FormControl type="time" placeholder="when" onChange={(event) => this.setState({ event_capacity: event.target.value })} />
                                </Col>
                                <Col componentClass={ControlLabel} sm={2}>
                                    Details:
                                </Col>
